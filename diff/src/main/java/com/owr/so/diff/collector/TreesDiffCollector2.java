...
public class TreesDiffCollector2 /* implements DiffCollector */ {

	//@Override
//	public void collect(RepoData tree1, RepoData tree2, DirTreesDiffResult result) {
//
...
//
//		RepoMetaData meta1 = new RepoMetaData(tree1);
//		RepoMetaData meta2 = new RepoMetaData(tree2);
//
//		// Files
//		meta1.getFiles().stream().filter(tree1File -> tree1File.getPath().startsWith(tree1.getSubDir()))
...
//	}
//
//	private void filePathTheSame(FileEntity tree1File, FileEntity tree2File, DirTreesDiffResult diffs,
//			boolean mirrorDiffScan) {
//		if (!mirrorDiffScan) {
//			// is modified?
...
//	}
//
//	private void filePathNotFound(FileEntity tree1File, RepoData tree1, RepoData tree2, DirTreesDiffResult diffs,
//			boolean mirrorScan) {
//
