...
public class ReposDifferences {
	...
	private DirTreesDifferences diffs;
	 ...
	 *
	 */
	public DirTreesDifferences findDifferences(DirTree tree1, DirTree tree2) {

		diffs = new DirTreesDifferences();
	...
	private void treeOneSideDiff(DirTree tree1, DirTree tree2, boolean mirrorDiffScan) {
	...
	private void findNewEmptyDir(String tree1Dir, DirTree tree1, DirTree tree2) {
	...
	private void findDiffSubdir(FileEntity tree1File, DirTree tree1, DirTree tree2,
	...
	private void filePathNotFound(FileEntity tree1File, DirTree tree1, DirTree tree2, boolean mirrorScan) {
