...
public class MainWindow {
	...
	private DirTreesBundle dirTreesBundle;
	private TreesDiffCollections treeDiffs;
	private IUIEventsListener eventsListener;

	public MainWindow(DirTreesBundle dirTreesBundle, TreesDiffCollections treeDiffs, IUIEventsListener eventsListener) {

		this.dirTreesBundle = dirTreesBundle;
